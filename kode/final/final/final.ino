...
//    client.println("Refresh: 5");  // refresh the page automatically every 5 sec
  ...
  client.println("<td align=center>");
  client.println("<font color = white size=5>");
  client.println(irPintuDalamValue);
  client.println("</td>");
  client.println("<td align=center>");
  client.println("<font color = white size=5>");
  client.println(pirPintuDalamValue);
  client.println("</td>");
  client.println("<td align=center>");
  client.println("<font color = white size=5>");
  ...
  client.print("<br>");
  client.println("Sensor 3 : IR Pintu Dalam ");
  client.print("<br>");
  client.println("Sensor 4 : PIR Pintu Dalam");
  client.print("<br>");
  client.println("Sensor 5 : PIR Jendela Dalam ");
